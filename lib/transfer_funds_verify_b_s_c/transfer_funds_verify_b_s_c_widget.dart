...
class TransferFundsVerifyBSCWidget extends StatefulWidget {
  const TransferFundsVerifyBSCWidget({Key key}) : super(key: key);

  @override
  _TransferFundsVerifyBSCWidgetState createState() =>
      _TransferFundsVerifyBSCWidgetState();
}

class _TransferFundsVerifyBSCWidgetState
    extends State<TransferFundsVerifyBSCWidget> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final transferFundsVerifyBSCUserResponse = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
